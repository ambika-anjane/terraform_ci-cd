...
resource "snowflake_pipe" "pipe" {
  ...
  copy_statement  = "COPY INTO  DEV_3.DEV_TEST_3.RAW_TRANSACTIONS FROM @DEV_3.DEV_TEST_3.STAGE_3 FILE_FORMAT = (TYPE = 'JSON')MATCH_BY_COLUMN_NAME = CASE_INSENSITIVE PATTERN = '.json$'"
  auto_ingest = true
