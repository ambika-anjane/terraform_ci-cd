...
resource "snowflake_pipe" "pipe" {
  ...
  copy_statement  = "COPY INTO  DEV_5.DEV_TEST_5.RAW_TRANSACTIONS FROM @DEV_5.DEV_TEST_5.STAGE_5 FILE_FORMAT = (TYPE = 'JSON')MATCH_BY_COLUMN_NAME = CASE_INSENSITIVE PATTERN = '.json$'"
  auto_ingest = true
